...
export default function Edit({ test, question }: Props) {
    const { data, setData, patch, processing, errors } = useForm<QuestionForm>({
        body: question.body,
    ...
    const submit: FormEventHandler = (event) => {
        ...
        patch(route('admin.tests.questions.update', [test.id, question.id]));
    };
